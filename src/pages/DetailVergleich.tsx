              ...
              <div className="flex flex-row gap-3 w-full">
                ...
                <div className="bg-white/80 backdrop-blur-md border border-white/40 rounded-2xl p-3 sm:p-4 flex items-center gap-2 sm:gap-4 flex-1 shadow-lg hover:bg-white transition-all group cursor-pointer" onClick={() => window.location.href = '/ueber-uns'}>
                  <div className="flex -space-x-3 group-hover:space-x-1 transition-all">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-white shadow-sm bg-gray-200 flex items-center justify-center text-xs font-bold text-gray-700">AS</div>
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-white shadow-sm bg-gray-800 flex items-center justify-center text-xs font-bold text-white">DA</div>
                  </div>
                  <div>
                    <div className="text-sm sm:text-base font-black text-gray-900 leading-tight">Experten Team</div>
                    <div className="text-[8px] sm:text-xs text-gray-600 font-bold uppercase tracking-tighter mt-0.5">Alexander & David</div>
                  </div>
                </div>
              </div>
            </div>
